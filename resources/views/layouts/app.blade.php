...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="{{asset('img/SPIT_logo.png')}}" type="image/icon type">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-1 col-sm-2 col-xs-3">
                                <a class="navbar-brand pull-left" href="/"><img src="{{asset('img/SPIT_logo.png')}}"/></a>
                            </div>
                            <div class="col-md-7 col-sm-7 col-xs-9">
                                <a class="navbar-brand pull-left" href="/"><img src="{{asset('img/logo.gif')}}"/></a>
                            </div>
                        </div>
                    </div>
                </div>
