    ...
    <div class="tab-content">
        ...
        <div id="menu1" class="container tab-pane fade"><br>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:18rem;height:25rem;margin:20px 0 24px 0">
                        <img class="card-img-top" src="<?php echo e(asset('img/SPIT_logo.png')); ?>" alt="image" style="width:100%;height:18rem">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nisarg/1 Sem 4/CI/rnd_template/iedc/resources/views/pages/index.blade.php ENDPATH**/ ?>